...
import data_utils_custom as data_utils
import seq2seq_model_custom as seq2seq_model
...
tf.app.flags.DEFINE_float("keep_prob",1.0,"The keep probability used for dropout.")
  ...
  with tf.Session() as sess:
    ...
    for i in range(FLAGS.steps_to_train):
      ...
      if current_step % FLAGS.steps_per_checkpoint == 0:
        ...
        logs.append(str(eval_val)+"\t"+str(perplexity))
